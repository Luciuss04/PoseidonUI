...
class Streaming(commands.Cog):
    ...
    async def on_presence_update(self, before: discord.Member, after: discord.Member):
        ...
        was_streaming = any(isinstance(act, discord.Streaming) for act in before.activities) if before.activities else False
        ...
        if not was_streaming and is_streaming and stream_activity:
            ...
            if channel:
                ...
                custom_msg = streaming_config.get("message", "¡@everyone **{user}** está en directo en {platform}! 🔴")
