...
class Analytics(commands.Cog):
    ...
    def _increment(self, guild_id, metric):
        ...
        if date not in self.data[gid]:
            self.data[gid][date] = {"messages": 0, "commands": 0, "joins": 0, "sentiment_sum": 0, "sentiment_count": 0}
    ...
    def get_guild_analytics(self, guild_id, days=7):
        ...
        for i in range(days):
            ...
            day_data = {"messages": 0, "commands": 0, "joins": 0, "sentiment_sum": 0, "sentiment_count": 0}
