...
class Status(commands.Cog):
    ...
    async def status(self, interaction: discord.Interaction):
        ...
        # Verificar permisos de administrador o roles de staff
        ...
        # Estado global de salud + color, título y footer dinámico
